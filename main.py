...
#             for selector in apply_selectors:
#                 try:
#                     logging.info(f"Attempting to find apply button with selector: {selector}")
#                     apply_button = self.wait.until(
#                         EC.element_to_be_clickable((By.CSS_SELECTOR, selector)))
#                     apply_button.click()
#                     logging.info("Apply button clicked successfully!")
...
#                     return
#                 except Exception as e:
#                     logging.error(f"Selector {selector} failed: {str(e)}")
#                     continue
...
#             # linkedin_value = self.credentials.get("linkedin profile")
...
#             for index, row in self.answers.items():
#                 question = safe_strip(row.get("Question"))
#                 answer = safe_strip(row.get("Answer"))
...
class AshbyAutomation:
    ...
    def load_config(self, file_location):
        ...
        required_fields = ["name", "email", "phone", "linkedin", "resume_path", "current_company", "current_location"]
        credentials = {}
